                        ...
                        <div class="card-body p-4">
                            ...
                            <form method="POST" action="{{ route('login.post') }}" novalidate>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" name="email"
                                            ...
                                            placeholder="admin@siakad.ac.id" value="{{ old('email') }}" autocomplete="email"
                                            required>
                                        @error('email')
                                ...
                                <div class="mb-4 d-flex align-items-center">
                                    ...
                                    <label class="form-check-label small text-muted" for="remember">Ingatkan saya</label>
                                </div>
                            ...
                            <div class="mt-3 p-2 rounded text-center"
                                style="background:#f8fafc;font-size:.75rem;color:#64748b">
